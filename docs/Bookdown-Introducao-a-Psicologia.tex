...
\includegraphics[width=1\linewidth]{Bookdown-Introducao-a-Psicologia_files/figure-latex/unnamed-chunk-2-1}
...
\caption{Livro Psicologias: Uma Introdução ao Estudo da Psicologia. 13.ed. São Paulo: Saraiva, 2001}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Fundadores da Gestalt: Max Wertheimer | Wolfgang Kohler | Kurt Koffka}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Kurt Lewin (1890-1947)}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Livro Teorias da Personalidade}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{Livro Psicologias: Uma Introdução ao Estudo da Psicologia. 13.ed. São Paulo: Saraiva, 2001}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{Fundadores da Gestalt: Max Wertheimer | Wolfgang Kohler | Kurt Koffka}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{Lei básica da percepção visual para os psicólogos da Gestalt}\label{fig:unnamed-chunk-18}
\end{figure}
...
\caption{Observe a RETA: Elemento que desejamos compreender}\label{fig:unnamed-chunk-19}
\end{figure}
...
\caption{Kurt Lewin (1890-1947)}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Livro Teorias da Personalidade}\label{fig:unnamed-chunk-21}
\end{figure}
